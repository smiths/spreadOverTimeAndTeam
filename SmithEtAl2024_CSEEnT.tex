...
\begin{axis}[
    ...
    bar width=0.2mm,
    width=0.5\textwidth,
    height=0.2\textwidth, %height=0.2\textwidth for poster and height=0.35\textwidth for paper
...
\begin{axis}[
    ...
    bar width=1.5mm,
    width=0.49\textwidth,
    height=0.2\textwidth, %height=0.2\textwidth for poster and height=0.3\textwidth for paper

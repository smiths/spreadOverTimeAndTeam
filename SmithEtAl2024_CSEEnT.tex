...
Specification (SRS) and Verification and Validation (VnV) plans and
...
default we keep things simple and standard between teams.  However, if a team
...
the problem. The encouraging feature a priori creation of rules is that the
difficult discussion happens while relationships between team members are likely
strong.  If a problem later occurs a team member doesn't have to muster the
courage to say that they are concerned with a colleague's performance, instead
they can point to the team charter and highlight the relevant, already
agreed upon rule.

...
We can apply the fairness metric in~\ref{Subsec:TimeSpread}
...
Section~\ref{Subsec:TimeSpread}, this metric shows that work was not well-spread-out,
...
time fairness metric, and in 2023/24, a weak positive correlation. We can
